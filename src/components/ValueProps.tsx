...
const props = [
{ icon: Leaf, title: "Sustainably Raised", desc: "Pasture-raised with environmental stewardship at the core of everything we do." },
{ icon: ShieldCheck, title: "No Hormones or Antibiotics", desc: "Clean, natural beef — the way it was meant to be. Nothing artificial, ever." },
